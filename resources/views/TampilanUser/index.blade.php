                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            ...
                            <div class="text-uppercase">DATA ANALYST</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">I can your help</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Saya adalah Mahasiswa Universitas Mercu Buana Yogyakarta</span></h1>
